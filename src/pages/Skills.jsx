...
import { Funnel, CircleFill, XLg, Gear } from 'react-bootstrap-icons';
      ...
      <div className="px-4 pt-5 mt-5 text-center">
        ...
        <div className="col-lg-6 mx-auto">
          <p className="lead mb-4">
            Analyse the <strong>key <Gear/> Skills</strong> defined by the ECSF.<br/>
            <em>An ECSF key skill is the ability to perform work functions and duties by a role profile.</em>
          </p>
        </div>
      </div>
                      ...
                      <Card>
                        <Card.Body className="pb-2">
                          <div className="row align-items-center">
                            ...
                            { framework.filters.forSkills.map(function(group, i) {
                              return (
