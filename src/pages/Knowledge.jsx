...
import { Funnel, CircleFill, XLg, Journals } from 'react-bootstrap-icons';
...
const Knowledge = () => {
  ...
  const handleNewFilter = (e) => {
    ...
    let group = framework.filters.forKnowledge.find(group => group.includes(tag));
    if (!group) return;
  ...
  const items2display = framework ? framework.keyKnowledge.filter(function(item, i){
      ...
      <div className="px-4 pt-5 mt-5 text-center">
        ...
        <div className="col-lg-6 mx-auto">
          <p className="lead mb-4">
            Analyse the <strong>key <Journals/> knowledge</strong> defined by the ECSF.<br/>
            <em>An ECSF key knowledge is the understanding required to perform a work role's functions and duties.</em>
          </p>
        </div>
      </div>
            ...
            <div className="col-12">
              { loading ? (
                ...
                <>
                      ...
                      <Card>
                        <Card.Body className="pb-2">
                          <div className="row align-items-center">
                            ...
                            { framework.filters.forKnowledge.map(function(group, i) {
                              return (
                  ...
                  <table className="ecsf-knowledge-list">
                    <tbody>
